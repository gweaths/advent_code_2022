...
var maxY_pt1 = 0;
var minX_pt1 = int.MaxValue;
var maxX_pt1 = int.MinValue;

foreach (int[][] position in data)
{
...
var cave1 = new Occupant[maxX_pt1 - minX_pt1 + 1, maxY_pt1 + 1];

var maxY2 = maxY_pt1 + 2;
var minX2 = Math.Min(minX_pt1, 500 - maxY2);
var maxX2 = Math.Max(maxX_pt1, 500 + maxY2);
var cave2 = new Occupant[maxX2 - minX2 + 1, maxY2 + 1];

foreach (var coords in data)
{
    var current = (coords[0][0], coords[0][1]);
    cave1[current.Item1 - minX_pt1, current.Item2] = Occupant.Rock;
...
long GetPart1() => FillCave(cave1, minX_pt1, maxX_pt1, maxY_pt1);

long GetPart2() => FillCave(cave2, minX2, maxX2, maxY2);
...
Console.WriteLine($"Pt 2: {part2Result}");
